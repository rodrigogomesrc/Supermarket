...
public class UserManager {
	...
	//@invariant users != null && updatesList != null;
	...
	//@ensures \result == (\exists ArrayList<String> productList; UserManager.getUsers().values().contains(productList); productList.contains(product.toLowerCase()));
	//@pure
